...
3. **Run the editor subagent** (`.github/instructions/editor.instructions.md`) to check style and formatting consistency
4. **Run the fact-checker subagent** (`.github/instructions/fact-checker.instructions.md`) to verify technical claims — stop if factual errors or sensitive information are found
